...
public class AuthServiceImpl implements AuthService {
    ...
    public boolean isTokenValid(String token) {
        ...
        wrapper.eq(SysLoginToken::getToken, hashToken(token));
    ...
    public void logout(String token) {
        ...
        log.info("[Auth] 退出登录成功: userId={}", loginToken != null ? loginToken.getUserId() : null);
    }
    ...
    private String hashToken(String token) {
        try {
            ...
            throw new IllegalStateException("令牌摘要计算失败", e);
        }
    }
}
